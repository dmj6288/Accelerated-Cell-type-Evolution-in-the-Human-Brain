...
seurat_object_path                <- "/home/local/ADS/dennis00/Yi_Lab/Lab_WorkDir/Dennis/Evolution/filtered_seurat/filtered_seurat_objects_species/RN018/Ma/"
...
filtered_human_seurat             <- readRDS(paste0(seurat_object_path, "HSB106.rds"))
filtered_chimp_seurat             <- readRDS(paste0(seurat_object_path, "PTB165.rds"))
filtered_macak_seurat             <- readRDS(paste0(seurat_object_path, "RMB161.rds"))
...
saveRDS(CreateSeuratObject(combined_matrix), paste0(output_path, "Ma_seurat_object.rds"))
