...
meta_data    <- read_excel("~/Yi_Lab/Lab_WorkDir/Dennis/Evolution/raw_data_processing_folder/Jorstad/Chimp_metadata.xlsx")
data_matrix  <- readRDS(paste0(data_path, "chimp_SCT_UMI_expression_matrix.RDS"))
