...
meta_data    <- read_excel("~/Yi_Lab/Lab_WorkDir/Dennis/Evolution/raw_data_processing_folder/Jorstad/Rhesus_metadata.xlsx")
data_matrix  <- readRDS(paste0(data_path, "rhesus_SCT_UMI_expression_matrix.RDS"))
