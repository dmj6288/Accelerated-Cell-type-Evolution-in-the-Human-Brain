...
Chimp_samples                <- all_files[stri_detect_fixed(all_files, "Jorstad_C")]
...
species_seurat <- merge(species_seurat_object_list[[1]], y = c(species_seurat_object_list[[2]],
							       ...
							       species_seurat_object_list[[4]],
                                                               ...
                                                               species_seurat_object_list[[7]]), project = "Jorstad_Chimp")

saveRDS(species_seurat, paste0(output_path, "Jorstad_Chimp.rds"))
