...
pseudo_bulk_ready_path     <- "/home/local/ADS/dennis00/Yi_Lab/Lab_WorkDir/Dennis/Evolution/pbds/pseudo_bulk_ready_data_018/"
results_path               <- "/home/local/ADS/dennis00/Yi_Lab/Lab_WorkDir/Dennis/Evolution/pbres/pseudo_bulk_analysis_results_018/"
...
source(paste(support_functions_path, "get_dds_resultsAvsB_age_018.R", sep = ""))

target_folders               <- list.files(pseudo_bulk_ready_path)

print(target_folders)
for (folder in target_folders[c(3, 4)]){
