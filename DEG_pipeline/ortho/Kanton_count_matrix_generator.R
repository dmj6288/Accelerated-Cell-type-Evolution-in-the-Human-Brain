...
seurat_object_path                <- "/home/local/ADS/dennis00/Yi_Lab/Lab_WorkDir/Dennis/Evolution/filtered_seurat/filtered_seurat_objects_species/RN018/Kanton/"
...
filtered_human_seurat             <- readRDS(paste0(seurat_object_path, "Kanton_Human.rds"))
filtered_chimp_seurat             <- readRDS(paste0(seurat_object_path, "Kanton_Chimp.rds"))
filtered_macak_seurat             <- readRDS(paste0(seurat_object_path, "Kanton_Macaque.rds"))
...
saveRDS(CreateSeuratObject(combined_matrix), paste0(output_path, "Kanton_seurat_object_ortho.rds"))
