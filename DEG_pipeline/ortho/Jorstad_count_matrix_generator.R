...
seurat_object_path                <- "/home/local/ADS/dennis00/Yi_Lab/Lab_WorkDir/Dennis/Evolution/filtered_seurat/filtered_seurat_objects_species/RN018/Jorstad/"
...
filtered_human_seurat             <- readRDS(paste0(seurat_object_path, "Jorstad_Human.rds"))
filtered_chimp_seurat             <- readRDS(paste0(seurat_object_path, "Jorstad_Chimp.rds"))
filtered_macak_seurat             <- readRDS(paste0(seurat_object_path, "Jorstad_Macaque.rds"))
