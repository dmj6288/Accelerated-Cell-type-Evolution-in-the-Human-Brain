...
Ma_cell_name_hash <- readRDS("D:/Yi/Evolution Paper/Metadata generator files/Ma et. al/Ma_cell_name_hash.rds")
...
```{r}
saveRDS(df_human_macak, "nonbarcode_changed_metadata_files_MD1/df_human_macak.rds")
saveRDS(df_human_chimp, "nonbarcode_changed_metadata_files_MD1/df_human_chimp.rds")
saveRDS(df_chimp_macak, "nonbarcode_changed_metadata_files_MD1/df_chimp_macak.rds")
```
