...
c("Barcode", "local_name", "Individual", "Segment")])
...
rownames(df_human_macak) <- paste(rownames(df_human_macak), df_human_macak$Individual, df_human_macak$Segment, sep = "_")
...
df_human_macak$Segment    <- as.factor(df_human_macak$Segment)
...
rownames(df_human_chimp) <- paste(rownames(df_human_chimp), df_human_chimp$Individual, df_human_chimp$Segment, sep = "_")
...
df_human_chimp$Segment    <- as.factor(df_human_chimp$Segment)
...
rownames(df_chimp_macak) <- paste(rownames(df_chimp_macak), df_chimp_macak$Individual, df_chimp_macak$Segment, sep = "_")
...
df_chimp_macak$Segment    <- as.factor(df_chimp_macak$Segment)
...
colnames(df_chimp_macak)         <- c("trad", "sample_id", "Segment", "human_age",  "sex")
colnames(df_human_chimp)         <- c("trad", "sample_id", "Segment", "human_age",  "sex")
colnames(df_human_macak)         <- c("trad", "sample_id", "Segment", "human_age",  "sex")
...
```{r}
saveRDS(df_human_macak, "pairwise_metadata_files_samples/df_human_macak.rds")
saveRDS(df_human_chimp, "pairwise_metadata_files_samples/df_human_chimp.rds")
saveRDS(df_chimp_macak, "pairwise_metadata_files_samples/df_chimp_macak.rds")
```
