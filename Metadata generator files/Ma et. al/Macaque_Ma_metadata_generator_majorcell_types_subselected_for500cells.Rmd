...
human_metadata_file <- human_metadata_file[human_metadata_file$subclass %in% cells_to_subselect, ]
chimp_metadata_file <- chimp_metadata_file[chimp_metadata_file$subclass %in% cells_to_subselect, ]
macak_metadata_file <- macak_metadata_file[macak_metadata_file$subclass %in% cells_to_subselect, ]
...
Ma_cell_name_hash <- readRDS("D:/Yi/Evolution Paper/Post processing runs/Metadata generator files/Ma et. al/Ma_cell_name_hash.rds")

human_metadata_file <- human_metadata_file[human_metadata_file$subclass %in% hash::keys(Ma_cell_name_hash),]
chimp_metadata_file <- chimp_metadata_file[chimp_metadata_file$subclass %in% hash::keys(Ma_cell_name_hash),]
macak_metadata_file <- macak_metadata_file[macak_metadata_file$subclass %in% hash::keys(Ma_cell_name_hash),]

human_metadata_file$subclass <- paste0(unlist(lapply(human_metadata_file$subclass, major_cells, Ma_cell_name_hash)), "_#human")
chimp_metadata_file$subclass <- paste0(unlist(lapply(chimp_metadata_file$subclass, major_cells, Ma_cell_name_hash)), "_#chimp")
macak_metadata_file$subclass <- paste0(unlist(lapply(macak_metadata_file$subclass, major_cells, Ma_cell_name_hash)), "_#macaque")
...
```{r}
saveRDS(df_human_macak, "metadata_with_neuron_subtypes_with_500cells_per_individual/df_human_macak.rds")
saveRDS(df_human_chimp, "metadata_with_neuron_subtypes_with_500cells_per_individual/df_human_chimp.rds")
saveRDS(df_chimp_macak, "metadata_with_neuron_subtypes_with_500cells_per_individual/df_chimp_macak.rds")
```
