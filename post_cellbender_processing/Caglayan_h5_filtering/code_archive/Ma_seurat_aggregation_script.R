...
seurat_folder_path <- "/home/local/ADS/dennis00/Yi_Lab/Lab_WorkDir/Dennis/Evolution/filtered_seurat/filtered_seurat_objects_cellbender_Ma_technical/"
seurat_files       <- list.files(seurat_folder_path)

print(seurat_files)
samples        <- unique(tstrsplit(seurat_files, "_")[[1]])

output_path    <- "/home/local/ADS/dennis00/Yi_Lab/Lab_WorkDir/Dennis/Evolution/filtered_seurat/filtered_seurat_objects_cellbender_Ma_biological/"
