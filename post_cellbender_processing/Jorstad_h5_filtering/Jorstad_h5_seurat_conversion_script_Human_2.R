...
Jorstad_seurat      <- readRDS("~/Yi_Lab/Lab_WorkDir/Dennis/Evolution/raw_data_processing_folder/Jorstad/potentially_processed_data/human_SCT_UMI_expression_matrix.RDS")
...
for (replicate in Human_donors[c(5:7)]){
	...
	Human_seurat_filt  <- comprehensive_filtering(Human_seurat, paste0("Jorstad_MTG_Human_", replicate))
