...
Macaque_samples              <- all_files[stri_detect_fixed(all_files, "Jorstad_Q")]
...
species_seurat <- merge(species_seurat_object_list[[1]], y = c(species_seurat_object_list[[2]],
                                                               species_seurat_object_list[[3]]), project = "Jorstad_Macaque")

saveRDS(species_seurat, paste0(output_path, "Jorstad_Macaque.rds"))
