...
for (study in study_results[c(1, 5)]){
	...
	for (cell_type in names(chimp_down_regulated)){
		...
		print(chimp_down_regulated_GO_cell_type)
...
saveRDS(chimp_down_regulated_GO, paste0(output_path, FDR1, FDR2, "chimp_down_regulated_GO.rds"))
saveRDS(human_down_regulated_GO, paste0(output_path, FDR1, FDR2, "human_down_regulated_GO.rds"))
saveRDS(chimp_up_regulated_GO,   paste0(output_path, FDR1, FDR2, "chimp_up_regulated_GO.rds"))
saveRDS(human_up_regulated_GO,   paste0(output_path, FDR1, FDR2, "human_up_regulated_GO.rds"))
}
}
