...
cell_counts_path               <- "../../Visualization_data/Figure S1/checkpoints/"
gene_table_path                <- "../../Visualization_data/Figure S1/"
cell_counts_files              <- list.files("../../Visualization_data/Figure S1/checkpoints/")
