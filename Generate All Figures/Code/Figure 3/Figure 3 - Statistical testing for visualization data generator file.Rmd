...
for (col in test_cols){
  ...
  if (col == "HAR_Count" || col == "cHAR_Count" || col == "tandem_Count" || col == "dNdS" || col == "Alpha" || col == "specificity_values"){
...
```{r}
saveRDS(heatmap_table, "../../Visualization_data/Figure 5/heatmap_table.rds")
```

```{r}

write_xlsx(heatmap_table, "../../Visualization_data/Figure 5/heatmap_table_V2.xlsx")

heatmap_table_plotting <- heatmap_table[heatmap_table$.y. != "specificity_values", ]

write_xlsx(heatmap_table_plotting, "../../Visualization_data/Figure 5/heatmap_table_for_plotting.xlsx")
...
write_xlsx(heatmap_table, "../../Visualization_data/Figure 5/heatmap_table_V3.xlsx")

heatmap_table_plotting <- heatmap_table[heatmap_table$.y. != "specificity_values", ]

write_xlsx(heatmap_table_plotting, "../../Visualization_data/Figure 5/heatmap_table_for_plotting_V3.xlsx")
