...
merged_counts <- readRDS("../../../Visualization - cellbender processed data - 018/loci_overlap_calculator/4.count_overlaps_and_integrate/Merged_counts/merged_counts_with_pvalues_all_considered_genes_V5.rds")
...
for (study in studies){
  ...
  for (spec in species_type[1]){
    ...
    for (cell_type in mini_cell_type_list) {
        ...
        df              <- df[, c("Gene",    "HAR_Count", "cHAR_Count", "Count_NeuN_hyper", "Count_NeuN_hypo", "Total_cellDMR_count", "Chimp_hypo", "Human_hypo", "Chimp_hyper", "Human_hyper", "tandem_Count", "dNdS", "major_celltypes", colnames(df)[18:37])]
...
saveRDS(barplot_table, "../../Visualization_data/Figure 3/full_table.rds")
