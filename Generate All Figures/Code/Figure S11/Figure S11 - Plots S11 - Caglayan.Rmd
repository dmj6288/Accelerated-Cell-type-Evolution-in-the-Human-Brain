...
source("../../Baseline/Figure S11 Baseline - Visualization all subtypes.R")

```

```{r}
lineplot_human_UR_list    <- readRDS(paste0("../../Visualization_data/Figure 4/cell_type_list_combo_V5.rds"))

for (cellname in cellnames_of_interest){
  ...
  ggsave(filename = paste0("../../Figures/Figure S19/", cellname, "all_subtypes_subset_combination_scatter_plot_blank_Version5_axis_PCC.jpg"), plot = p, device = "jpeg",
...
length(unique(c(Ma0.05_original_HUMAN_DRGenes[["Excite"]], Ma0.05_original_HUMAN_DRGenes[["Inhibit"]], Ma0.05_original_HUMAN_URGenes[["Excite"]], Ma0.05_original_HUMAN_URGenes[["Inhibit"]])))